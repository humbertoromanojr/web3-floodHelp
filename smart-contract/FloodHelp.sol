...
contract FloodHelp {
    ...
    function closeRequest(uint id) public {
        ...
        require(msg.sender == author && (msg.sender == author || balance >= goal), 'You cannot close this order, only the owner can.');
    ...
    function getRequests(uint startId, uint quantity) public view returns ( Request[] memory) {
